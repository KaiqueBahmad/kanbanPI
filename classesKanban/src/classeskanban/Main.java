...
public class Main {
    public static void main(String[] args) {
        ...
        users[0].getProjetos()[0].getDepartamentoByNome("Financeiro").adicionarAtividade(new Atividade(users[0].getProjetos()[0].getDepartamentoByNome("Financeiro"),"Atividade 1", 1200, 3600));
